...
class Keyboard {
     ...
     */
    reset() {
        this.options = {...Keyboard.defaultOptions }
        this.buttons = []
        this.makeFunction = null
        this.makeOptions = {}
     ...
     */
    splice(...args) {
        return this.buttons.splice(...args)
    }
     ...
     */
    inline(extraMarkup) {
        return this.draw('inline_keyboard', formatInlineButtons(this.buttons), extraMarkup)
    }
     ...
     */
    reply(extraMarkup) {
        return this.draw('keyboard', formatBuiltInButtons(this.buttons), extraMarkup)
    }
    ...
    // helpers
    draw(keyboardType, buttons = [], extraMarkup = {}) {

...
class Keyboard {
     ...
     * @param {boolean} value
     * @example
     * Keyboard.make(['Button']).resize().builtIn()
     * 
     * @return {Keyboard}
     */
    resize (value = true) {
     ...
     * @param {boolean} value
     * @example
     * Keyboard.make(['Button']).forceReply().builtIn()
     * 
     * @return {Keyboard}
     */
     ...
     * @param {boolean} value
     * @example
     * Keyboard.make(['Button']).selective().builtIn()
     * 
     * @return {Keyboard}
     */
     ...
     * @param {boolean} value
     * @example
     * Keyboard.make(['Button']).oneTime().builtIn()
     * 
     * @return {Keyboard}
     */
    oneTime(value = true) {
     ...
     * @param {boolean} value
     * @example
     * Keyboard.make(['Button']).removeKeyboard().builtIn()
     * 
     * @return {Keyboard}
     */
